...
<template>
  <div class="bg-bg min-h-screen">
    <!-- ─── Hero ──────────────────────────────────────────────────────────────── -->
    <section class="relative overflow-hidden pt-20 pb-24 md:pt-32">
      ...
      <div class="relative mx-auto max-w-6xl px-6">
        ...
        <p
          ...
          "
        >
          Hello! My name is Jens Johnson. I am a full-stack software engineer based in San Diego, California, currently
          working with the Product Management team at the Gemological Institute of America, where I help build tools and
          software solutions to empower and serve consumers and manufacturers across the global gemological and diamond
          industries. I am deeply passionate about the intersection of technology and human-driven design, and I believe
          that the most impactful products are created when technical excellence meets empathy, creativity, and a
          genuine understanding of the people they serve.
        </p>
      </div>
    </section>
    ...
    <section class="border-border border-t">
      <div class="mx-auto max-w-6xl px-6 py-20">
        ...
        <div class="grid auto-rows-auto grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-12">
          ...
          <ContainmentBentoCard class="border-border bg-surface relative rounded-2xl border p-6 lg:col-span-4">
            <WidgetsMetricsCard />
          </ContainmentBentoCard>
        </div>
      </div>
      ...
      <div class="mx-auto max-w-6xl px-6 py-20">
        ...
        <div class="space-y-0">
          <div
            ...
            class="border-border grid gap-6 border-t py-10 md:grid-cols-[200px_1fr]"
    ...
    <section class="border-border border-t">
      <div class="mx-auto max-w-6xl px-6 py-20">
        <div class="mb-12 grid gap-4 md:grid-cols-[200px_1fr]">
          <p class="text-caption text-ink-subtle font-mono tracking-widest uppercase">Stack</p>
        </div>
          ...
          <div v-for="group in stack" :key="group.category" class="border-border bg-surface rounded-xl border p-5">
            ...
            <div class="flex flex-wrap gap-2">
              <span
                ...
                :key="item"
                class="bg-bg font-body text-body-sm text-ink-muted rounded-full px-3 py-1"
              >
                {{ item }}
              </span>
            </div>
    ...
    <section class="border-border bg-surface border-t">
      <div class="mx-auto max-w-6xl px-6 py-20">
        <div class="grid gap-8 md:grid-cols-[200px_1fr] md:items-center">
          <p class="text-caption text-ink-subtle font-mono tracking-widest uppercase">Connect</p>

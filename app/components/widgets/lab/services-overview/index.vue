 ...
 *
 * The Services tab on the Substrate page: a responsive grid of service cards (icon, status, stack), each linking to its
 * detail page. Renders an empty-state when no services are documented yet.
 *
 * ─── PROPS ───────────────────────────────────────────────────────────────────────────────────────────────────────────
 *
 *   • services
 *     - Description: The documented homelab services to render as cards
 *     - Type: IHomelabService[]
 *     - Required: true
 *
 * █████████████████████████████████████████████████████████████████████████████████████████████████████████████████████
 */
      ...
      >
        ...
        >
          ...
          <div class="mb-4 flex items-start justify-between gap-3">
            ...
            >
              <Icon
                :name="svc.icon ?? serviceKindIcon(svc.kind)"
                size="22"
              />
            </span>
            ...
            >
              <span
                ...
                :class="serviceStatusOf(svc.status).dot"
              />
          ...
          >
            ...
            <li
              v-if="svc.stack.length > 4"
              class="text-caption text-ink-subtle px-1 py-0.5 font-mono"
            >
              +{{ svc.stack.length - 4 }}
            </li>
          </ul>
          ...
          <div class="mt-auto flex items-center justify-between pt-5">
            <span
              v-if="svc.host"
              class="text-caption text-ink-subtle inline-flex items-center gap-1.5 font-mono"
            >
              <Icon
                name="lucide:cpu"
                size="12"
